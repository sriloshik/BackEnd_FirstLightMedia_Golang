...
## My List - Remove video from my wish list - API Specification
...
```
https://<server>/user/favorite/delete/{itemId}
```
...
```json
DELETE https://server/user/favorite/delete/content-123
...
```json
{
  "header": {
    ...
    "code": -1,
    "message": "Failure",
    "system_time": 1632131465589,
    "tracking_id": "aeee9c9e-062c-4549-8a06-9ec48a723555",
    "errors": [
      {
        "code": "40040201",
...
```
The following response is an example of failure due to item identifier not found in database,
