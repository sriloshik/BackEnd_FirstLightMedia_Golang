...
## Continue Watching - Remove player offset - API Specification
...
```
https://<server>/user/bookmark/delete/{itemId}
```
...
```json
DELETE https://server/user/bookmark/delete/{itemId}
...
```json
{
  "header": {
    ...
    "code": 0,
    "message": "Success",
    "system_time": 1632116531493,
    "tracking_id": "840a890a-6881-46fb-af09-501935e79b64"
  }
}
```
...
The following response is an example of failure delete due to invalid or missing authorization token:
...
```json
{
  "header": {
    ...
    "code": -1,
    "message": "Failure",
    "system_time": 1632116463817,
    "tracking_id": "72f9821a-777c-4854-8450-ed0e9e25b248",
    "errors": [
      {
        "code": "40080201",
...
```json
{
  "header": {
    ...
    "code": -1,
    "message": "Failure",
    "system_time": 1632116557886,
    "tracking_id": "3b9c941a-8cdb-4cff-802e-dd86844266e6",
    "errors": [
      {
        "code": "40080203",
