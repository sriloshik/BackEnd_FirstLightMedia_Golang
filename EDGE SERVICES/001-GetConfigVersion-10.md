...
## Get Config Version - API Specification
...
```
https://<server>/remote/config/{id}/versions
```
...
```json
GET https://server/remote/config/71574E0A-E084-41C7-987E-C951D8D7B213/versions?pageNumber=1&pageSize=100
...
```json
{
  "header": {
    ...
    "code": 0,
    "message": "Success",
    "system_time": 1632216079845,
    "start": 1,
    "rows": 1,
    "count": 1,
    "tracking_id": "1386086b-c90f-420a-ad08-681c488eb59e"
  },
  "data": [
    {
      "id": "71574E0A-E084-41C7-987E-C951D8D7B213",
      "key": "71574E0A-E084-41C7-987E-C951D8D7B213-1624264712",
      "st": "draft"
    }
  ]
}
...
```json
{
  "header": {
    ...
    "code": -1,
    "message": "Failure",
    "system_time": 1632216271836,
    "tracking_id": "04aa4654-ff5d-4edf-a4e9-4d1c0d833625",
    "errors": [
      {
        "code": "40011002",
...
```json
{
  "header": {
    ...
    "code": -1,
    "message": "Failure",
    "system_time": 1632216359106,
    "tracking_id": "e29146d6-2d68-4fd1-ab64-18bcb9ddbc03",
    "errors": [
      {
        "code": "40011003",
